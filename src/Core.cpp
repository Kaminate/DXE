...
Core::Core(HINSTANCE hInstance) : mhAppInst(hInstance) {
...
HINSTANCE Core::AppInst()const
{
	return mhAppInst;
}

HWND Core::MainWnd()const
{
	return mhMainWnd;
}
...
void Core::OnResize()
{
	...
	depthStencilDesc.Format = mDepthStencilFormat_OnResize;
