...
struct ShadowMapData {
	...
	XMFLOAT3 mRotatedLightDirections = XMFLOAT3(0.2f, -0.5f, -0.16f);
};
...
public:
	...
	const D3D12_GPU_DESCRIPTOR_HANDLE& getGPUHandle4SRV()const;
	const D3D12_CPU_DESCRIPTOR_HANDLE& getCPUHandle4DSV()const;
