...
inline std::wstring ToWString( std::string s ) { std::wstring w; for( char c : s )  w += ( wchar_t )c; return w; }
...
public:
        ...
        mIsConstantBuffer(isConstantBuffer)
    {
        ...
        if (isConstantBuffer)
            ...
            auto rscDsc = CD3DX12_RESOURCE_DESC::Buffer(mElementByteSize * elementCount);
